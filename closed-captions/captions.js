...
// Dreadfully distinct
captions[65] = ['113', '114.98'];
captions[66] = ['114.12', '114.98'];
captions[67] = ['115.02', '116.26'];
// -Dark
captions[68] = ['115.56', '116.26'];
captions[69] = ['116.26', '117.4'];
captions[70] = ['117.4', '118.43'];
// Withing one stem
captions[71] = ['118.44', '121.28'];
captions[72] = ['120.46', '121.28'];
captions[73] = ['121.4', '123.86'];
// -And dreadfully distinct
captions[74] = ['122.66', '123.86'];
captions[75] = ['123.98', '125.52'];
